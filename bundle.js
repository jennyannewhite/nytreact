...
/***/ (function(module, exports, __webpack_require__) {
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        var _search_bar = __webpack_require__(173);
    
        var _search_bar2 = _interopRequireDefault(_search_bar);
    
        var _article_list = __webpack_require__(174);
    
        var _article_list2 = _interopRequireDefault(_article_list);
    
        var _article_detail = __webpack_require__(176);
        ...
        var App = function (_Component) {
          ...
          _createClass(App, [{
            key: 'handleUserInput',
            value: function handleUserInput(obj) {
              this.setState(obj);
            }
          }, {
            key: 'handleSubmit',
            value: function handleSubmit() {
              ...
              var queryUrl = "https://api.nytimes.com/svc/search/v2/articlesearch.json?" + "api-key=d4d1ec204df7441692d2d8ed2d7bccef&sort:newest&q=" + this.state.searchTerm;
              return (0, _axios2.default)({
                ...
                var articles = results.data.response.docs.map(function (article) {
                  return article;
                });
            ...
            value: function render() {
              ...
              return _react2.default.createElement(
                ...
                _react2.default.createElement(_search_bar2.default, {
                  ...
                  onSearchFormSubmit: function onSearchFormSubmit() {
                    return _this3.handleSubmit();
                  },
                  onSearchTermChange: function onSearchTermChange(obj) {
                    return _this3.handleUserInput(obj);
                  }
                }),
                _react2.default.createElement(_article_detail2.default, { article: this.state.selectedArticle }),
                _react2.default.createElement(_article_list2.default, {
                  onArticleSelect: function onArticleSelect(selectedArticle) {
                    return _this3.setState({ selectedArticle: selectedArticle });
                  },
        ...
        var SearchBar = function (_Component) {
          ...
          function SearchBar(props) {
            ...
            _this.handleChange = function (event) {
              ...
              _this.props.onSearchTermChange(obj);
            };
    
            _this.handleSubmit = function (event) {
              event.preventDefault();
              _this.props.onSearchFormSubmit();
            };
          ...
          _createClass(SearchBar, [{
            ...
            value: function render() {
              ...
              return _react2.default.createElement(
                ...
                _react2.default.createElement("input", { className: "btn btn sharp", type: "submit", value: "Search" })
              );
            }
          }]);
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        var _article_list_item = __webpack_require__(175);
    
        var _article_list_item2 = _interopRequireDefault(_article_list_item);
    
        function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
    
        var ArticleList = function ArticleList(props) {
    
          var articleItems = props.articles.map(function (article) {
            return _react2.default.createElement(_article_list_item2.default, {
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        var ArticleListItem = function ArticleListItem(props) {
          ...
          var onArticleSelect = props.onArticleSelect;
    
          // console.log(article.web_url);
    
          var newsSource = article.source;
          var headline = article.headline.main;
          var articleURL = article.web_url; // to be included later
    
          return _react2.default.createElement(
            "li",
            { onClick: function onClick() {
                return onArticleSelect(article);
              }, className: "list-group-item" },
            _react2.default.createElement(
              "div",
              { className: "article-list media" },
              _react2.default.createElement("div", { className: "media-left" }),
              _react2.default.createElement(
                "div",
